...
<body>
	<br>
   <h2 align="center">Onffice 개인정보 동의</h2>
   <br>
   <hr>
   <br>
   
	   <textarea rows="20" cols="150" readonly>가. 수집하는 개인정보의 항목첫째, 회사는 회원가 입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.
회원가입
...
- 생성정보 수집 툴을 통한 수집
   ...
   <br>
   <div align="center">
   <input type="checkbox" id="req"> 개인정보 수집 및 이용에 동의합니다. <br>
   <br>
   <button class="btn btn-dark" id="nextbtn" onclick="checkNext()">다음</button>
   <button class="btn btn-dark" id="backbtn" onclick="goLogin()">돌아가기</button>
   <br>
   </div>
   <script>
   		...
   		let checkstat = document.getElementById("req").checked;
